...
graph LR
  ...
  click ZetaZeroes_v1_zeroes_off_axis_in_strip href "https://github.com/teorth/IEANTN/blob/main/docs/nodes/ZetaZeroes-v1.md#zeroes_off_axis_in_strip" _blank
  click ZetaZeroes_v1_zeta_eq_zero_iff_zeta1 href "https://github.com/teorth/IEANTN/blob/main/docs/nodes/ZetaZeroes-v1.md#zeta_eq_zero_iff_zeta1" _blank
  click ZetaZeroes_v1_zeta_eq_zeta1_div href "https://github.com/teorth/IEANTN/blob/main/docs/nodes/ZetaZeroes-v1.md#zeta_eq_zeta1_div" _blank
```
