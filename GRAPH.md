...
graph LR
  ...
  NPrimeInterval_v1["<b>PrimeInterval.v1</b><br/>4 claims<br/><i>weakest: unjustified</i>"]
  ...
  class NBrown1967_v1,NButhe_v2,NChengGraham2004_v1,NContourIntegration_v1,NGammaAsymptotics_v1,NMTY_v1,NPrimeInterval_v1 none_yet;
  ...
  class NCH2_v2,NCH2_v3,NCH2_v4,NDudekPlatt_v2,NDudekPlatt_v3,NFKS2_v1,NFKS2_v2,NLcm_v1,NLcm_v2,NZeroFreeHeight_v1,NZetaLogDeriv_v1 lean_comparator;
...
graph LR
  ...
  subgraph sgPrimeInterval_v1["PrimeInterval.v1"]
    PrimeInterval_v1_classicalBound_hasPrimeInInterval["<b>classicalBound_hasPrimeInInterval</b><br/><i>unjustified</i>"]
    PrimeInterval_v1_eTheta_criterion["<b>eTheta_criterion</b><br/><i>unjustified</i>"]
    PrimeInterval_v1_numericalBound_hasPrimeInInterval["<b>numericalBound_hasPrimeInInterval</b><br/><i>unjustified</i>"]
    PrimeInterval_v1_theta_characterisation["<b>theta_characterisation</b><br/><i>unjustified</i>"]
  end
...
- [`PrimeInterval.v1.classicalBound_hasPrimeInInterval`](docs/nodes/PrimeInterval-v1.md#classicalBound_hasPrimeInInterval) — unjustified

- [`PrimeInterval.v1.eTheta_criterion`](docs/nodes/PrimeInterval-v1.md#eTheta_criterion) — unjustified

- [`PrimeInterval.v1.numericalBound_hasPrimeInInterval`](docs/nodes/PrimeInterval-v1.md#numericalBound_hasPrimeInInterval) — unjustified

- [`PrimeInterval.v1.theta_characterisation`](docs/nodes/PrimeInterval-v1.md#theta_characterisation) — unjustified
...
| [`PrimeInterval.v1.classicalBound_hasPrimeInInterval`](docs/nodes/PrimeInterval-v1.md#classicalBound_hasPrimeInInterval) | unjustified | 0 | none |
| [`PrimeInterval.v1.eTheta_criterion`](docs/nodes/PrimeInterval-v1.md#eTheta_criterion) | unjustified | 0 | none |
| [`PrimeInterval.v1.numericalBound_hasPrimeInInterval`](docs/nodes/PrimeInterval-v1.md#numericalBound_hasPrimeInInterval) | unjustified | 0 | none |
| [`PrimeInterval.v1.theta_characterisation`](docs/nodes/PrimeInterval-v1.md#theta_characterisation) | unjustified | 0 | none |
